...
class TestLoadParticipantDetails:
    ...
    def test_should_map_rtsa_side(self, rtsa_r, rtsa_l, expected):
    ...
    def test_should_map_tsa_side(self, tsa_r, tsa_l, expected):
        participants = _load_from_rows(
            [
                {
                    "fname": "participant-b",
    ...
    def test_should_map_dominant_arm(self, r_dom, l_dom, expected):
        participants = _load_from_rows(
            [
                {
                    "fname": "participant-c",
    ...
    def test_should_reject_invalid_dominant_arm_flags(self, r_dom, l_dom):
    ...
    def test_should_preserve_filename_and_age(self, filename, age):
        participants = _load_from_rows(
            [
                {
                    "fname": filename,
    ...
    def test_should_reject_same_arm_rtsa_and_tsa(
        self, rtsa_r, rtsa_l, tsa_r, tsa_l
    ):
